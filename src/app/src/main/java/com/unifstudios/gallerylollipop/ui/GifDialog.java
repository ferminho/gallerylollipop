...
public class GifDialog extends DialogFragment implements AnimatedGifDrawable.UpdateListener {
    ...
    private View createDialog() {
        ...
        gifView = (GifView) view.findViewById(R.id.imageViewGif);
...
//            if (mDrawable != null) {
//                gifView.setImageDrawable(mDrawable);
//            } else {
//                gifView.setImageResource(android.R.drawable.stat_notify_error);
//            }
        }
    };
    ...
    public void update() {
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                gifView.invalidate();
                gifView.invalidateDrawable(mDrawable);
            }
        });
    }
}
