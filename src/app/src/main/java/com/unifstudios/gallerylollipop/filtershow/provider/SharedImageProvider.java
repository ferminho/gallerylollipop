...
package com.unifstudios.gallerylollipop.filtershow.provider;
...
public class SharedImageProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.unifstudios.gallerylollipop.filtershow.provider.SharedImageProvider";
